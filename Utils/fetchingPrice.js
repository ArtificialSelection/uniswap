...
//const MAINNET_URL = $ETHERSCAN_MAINNET_URL;

const provider = new ethers.providers
  .JsonRpcProvider(`${process.env.MAINNET_URL}`);
...
export const getPrice = async (inputAmount, poolAddress) => {
  ...
  const tokenSymbol0 = await tokenAddress0.symbol();
  const tokenSymbol1 = await tokenAddress1.symbol();
